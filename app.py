...
async def index(request: Request):
    return templates.TemplateResponse(request=request,name="data.html",context={"context": "Rendering"})
# @app.get("/train")
...
async def predictRouteClient(request: Request):
    try:
        ...
        vehicle_data = VehicleData(Gender= form.Gender,Age = form.Age,Driving_License = form.Driving_License,Region_Code = form.Region_Code,
        Previously_Insured = form.Previously_Insured,Annual_Premium = form.Annual_Premium,Policy_Sales_Channel = form.Policy_Sales_Channel,
        Vintage = form.Vintage,Vehicle_Age_lt_1_Year = form.Vehicle_Age_lt_1_Year,
        Vehicle_Age_gt_2_Years = form.Vehicle_Age_gt_2_Years,Vehicle_Damage_Yes = form.Vehicle_Damage_Yes)
        ...
        return templates.TemplateResponse(request=request,name="data.html",context={"context": status})
