...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            metric_dir = os.path.dirname(self.model_trainer_config.metric_report_file_path)
            ...
            write_yaml_file(self.model_trainer_config.metric_report_file_path, metric_report)

            model_trainer_artifact = ModelTrainerArtifact(
                trained_model_file_path=self.model_trainer_config.trained_model_file_path,
                metric_artifact=metric_artifact,
                metric_report_file_path=self.model_trainer_config.metric_report_file_path,
            )
